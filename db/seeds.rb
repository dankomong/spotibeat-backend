...
artist1 = Artist.create(name: "The Killers", spotify_id: "fuck")
album1 = Album.create(name: "Hot Fuss", spotify_id: "fuck")
track1 = Track.create(name: "Mr Brightside", spotify_id: "fuck", album: album1)
...
track2 = Track.create(name: "If I never see your face again", spotify_id: "shiet", album: album1)
artist2 = Artist.create(name: "Maroon 5", spotify_id: "shiet")
artist3 = Artist.create(name: "Rihanna", spotify_id: "bread")
album2 = Album.create(name: "It wont be soon before long", spotify_id: "shiet")
